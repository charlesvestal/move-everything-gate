#!/usr/bin/env bash
# Build GATE module for Move Anything (ARM64)
#
...
if [ -z "$CROSS_PREFIX" ] && [ ! -f "/.dockerenv" ]; then
    echo "=== GATE Module Build (via Docker) ==="
    echo ""
...
cd dist
tar -czvf gate-module.tar.gz gate/
cd ..

echo ""
echo "=== Build Complete ==="
echo "Output: dist/gate/"
echo "Tarball: dist/gate-module.tar.gz"
echo ""
